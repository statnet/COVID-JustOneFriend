...
author: <font size="3" color="606060"> *Goodreau SM, Pollock ED, Birnbaum JK, Hamilton DT, Morris M, on behalf of the Statnet Development Team* </font>
date: "4/3/2020"
output:
  html_document:
    highlight: kate
...
Let's start by imagining back to the good old days before COVID-19 took off.  People had lots of daily interactions with lots of other people. They varied in how many---some people had many, and some had few---but overall the average was a lot higher. Let's say, for the sake of the example, that the average household had 15 regular interactions with other households.

Now try to imagine what that might look like if you drew it. Often we visualize networks like this using diagrams with nodes and links.  Here we'll make one in which the **nodes (green dots) represent individual households**, and the **links (gray lines) represent frequent, repeated interactions** between any members of two households. 

We'll look at 200 households and 15 ties per household (the exact number doesn't matter much here---we just want to imagine a world that is much more connected than it is under social distancing). **What do we see?**
 
[For those who want to read more detail---including a few more terms and numbers---click on the "What's Going On"? button, here and in each example below. For those who just want to compare the pictures, continue on.]
