---
title: "Can't I <i>please</i> just visit one friend?"
subtitle: "Visualizing social distancing networks in the era of COVID-19"
author: 
 - Steven M. Goodreau & Martina Morris, University of Washington
date: "4/3/2020"
output:
...
### __The Situation__ <br/> COVID-19 is raging around the world, and you and your family have been asked (OK, told) to stay home and practice social distancing.
...
### __The Good Ol' Days__ <br/>  Let's start by imagining back to the good old days, just a few short weeks or months ago, before COVID-19 took off.  {data-commentary-width=550}
...
```{r pre-COVID, cache=FALSE, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE}
library(statnet)
set.seed(0)
n <- 200
...
### __Perfect isolation__ <br/>  Now let's imagine the other extreme, complete lock-down  {data-commentary-width=550}
...
### __Adding in the essential workers__ <br/>  Let's be realistic. Perfect isolation is impossible.  {data-commentary-width=550}
...
### __Visiting just one friend__ <br/>  Social distancing gets boring after a while. Can we ease up just a little?  {data-commentary-width=550}
...
### __Visiting just one friend per household__ <br/> OK, maybe households with multiple people could alla gree that only one person can hang out with one friend?   {data-commentary-width=550}
...
### __Lessons learned__ <br/> We are much more connected than we realize.
...
### __The fine print__ <br/> for those who are interested, model caveats and code {data-commentary-width=550}
